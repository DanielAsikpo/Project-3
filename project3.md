...
For each task, we need to create **routes** that will define various endpoints that the Todo app will depend on. So let us create a folder routes
...
In Routes directory, open api.js with `nano api.js`, delete the code inside and paste the code below into it then save and exit
...
[Click Install Postman to download and install postman on your machine.](https://www.getpostman.com/downloads/)

You should test all the API endpoints and make sure they are working. For the endpoints that require body, you should send JSON back with the necessary fields since it’s what we setup in our code.

Now open your Postman, create a POST request to the API http://<PublicIP-or-PublicDNS>:5000/api/todos. This request sends a new task to our Todo list so the application could store it in the database.
...
`cd ../..` and install Axios with the command below:
